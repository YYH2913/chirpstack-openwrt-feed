...
return view.extend({
    render: function () {
        const options = {
            ...
            chipsets: [
                {
                    ...
                    shields: [
                        {
                            id: "dragino_lps8_sx1308",
                            name: "Dragino - LPS8 (SX1308)",
            ...
            regions: [
                { id: "AS923",   name: "AS923",   channelPlans: [ { id: "as923",   name: "AS923 - Standard channels + 923.6, 923.8, ... 924.6" } ] },
                { id: "AS923_2", name: "AS923-2", channelPlans: [ { id: "as923_2", name: "AS923-2 - Standard channels + 921.8, 922.0, ... 922.8" } ] },
                { id: "AS923_3", name: "AS923-3", channelPlans: [ { id: "as923_3", name: "AS923-3 - Standard channels + 917.0, 917.2, ... 918.0" } ] },
                { id: "AS923_4", name: "AS923-4", channelPlans: [ { id: "as923_4", name: "AS923-4 - Standard channels + 917.7, 917.9, ... 918.7" } ] },
                { id: "AU915",   name: "AU915",   channelPlans: [
                ...
                { id: "EU868",   name: "EU868",   channelPlans: [ { id: "eu868",   name: "EU868 - Standard channels + 867.1, 867.3, ... 867.9" } ] },
                { id: "IN865",   name: "IN865",   channelPlans: [ { id: "in865",   name: "IN865 - Standard channels" } ] },
                { id: "KR920",   name: "KR920",   channelPlans: [ { id: "kr920",   name: "KR920 - Standard channels" } ] },
                { id: "RU864",   name: "RU864",   channelPlans: [ { id: "ru864",   name: "RU864 - Standard channels" } ] },
                { id: "US915",   name: "US915",   channelPlans: [
